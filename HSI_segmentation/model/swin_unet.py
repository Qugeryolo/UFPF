...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=60, num_classes=1000,
    ...
    def up_x4(self, x):
        ...
        if self.final_upsample == "expand_first":
            ...
            x1 = x.permute(0, 3, 1, 2).contiguous()  # B,C,H,W
            x = self.output(x1)
...
if __name__ == '__main__':
    model = swinunet(2, 256)
    print(model)
    model.eval()
    input = torch.rand(4, 60, 256, 256)
    output = model(input)
