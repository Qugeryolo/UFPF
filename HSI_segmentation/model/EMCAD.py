...
class PyramidVisionTransformerImpr(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=60, num_classes=2, embed_dims=[64, 128, 256, 512],
...
class EMCADNet(nn.Module):
    def __init__(self, num_classes=2, kernel_sizes=[1, 3, 5], expansion_factor=2, dw_parallel=True, add=True, lgag_ks=3,
