...
if __name__ == '__main__':
    img_size = 256
    x = torch.rand(2, 60, img_size, img_size).cuda()

    # focal tiny
    model1 = FocalTransformer(in_chans=60, num_classes=2,
    ...
    # focal small
    model2 = FocalTransformer(in_chans=60, num_classes=2,
                             img_size=img_size, embed_dim=96, depths=[2, 2, 18, 2], drop_path_rate=0.2,
                             focal_levels=[2, 2, 2, 2], expand_sizes=[3, 3, 3, 3], expand_layer="all",
                             num_heads=[3, 6, 12, 24],
                             focal_windows=[7, 5, 3, 1],
                             window_size=7,
    ...
    # focal base
    model3 = FocalTransformer(in_chans=60, num_classes=2,
                             img_size=img_size, embed_dim=128, depths=[2, 2, 18, 2], drop_path_rate=0.2,
                             focal_levels=[2, 2, 2, 2], expand_sizes=[3, 3, 3, 3], expand_layer="all",
                             num_heads=[4, 8, 16, 32],
                             focal_windows=[7, 5, 3, 1],
                             window_size=7,
