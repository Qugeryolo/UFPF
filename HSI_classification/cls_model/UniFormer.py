...
class UniFormer(nn.Module):
    ...
    def __init__(self, depth=[3, 4, 8, 3], img_size=256, in_chans=40, num_classes=3, embed_dim=[64, 128, 320, 512],
...
if __name__ == '__main__':
    model = uniformer_base().cuda()
    print(model)
    input_tensor = torch.randn(1, 40, 256, 256).cuda()
