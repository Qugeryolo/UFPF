...
class STViT(nn.Module):
    def __init__(self, in_chans=3, num_classes=18,
...
def throughput(model):
    ...
    images = torch.randn(1, 60, 256, 256).cuda()
...
def main():
    ...
    model.eval()
    flops = FlopCountAnalysis(model, torch.rand(1, 60, 256, 256))
